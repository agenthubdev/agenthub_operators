...
class FilterOperator(BaseOperator):
    ...
    def declare_description():
        return 'This operator filters out items in a list that contain a keyword.'
        ...
        return [
            {
                ...
                "description": "Keyword to filter out items"
            }
        ]
    ...
    def run_step(self, step, ai_context):
        ...
        filtered_list = [item for item in input_list if re.search(keyword, item)]
